...
- set `NEXT_PUBLIC_REGISTRY_ADDRESS` to your deployed Mainnet contract address (from `npm run deploy:contract:mainnet`)
...
wallet. The wallet must be connected to BOT Chain Mainnet (chain ID `677`) and have
...
2. Connect a wallet configured for BOT Chain Mainnet.
